    ...
    if 1==1:
        if os.path.exists(f"{ars}{num}/{filename}/ancestor.json"):
            ...
            if 1==1:
                ...
                '''
                print(f"python /jdfssz1/ST_EARTH/P18Z10200N0100/dingpengjun/100.c-dingpengjun/ars_py/dddcollect_branch_omegas.py {ars}{num}/{filename}/test.txt  {ars}{num}/{filename} {ars}{num}/{filename}/{filename}_ancestor.json >{ars}{num}/{filename}/{filename}_test 2>{ars}{num}/{filename}/test.log\n")
