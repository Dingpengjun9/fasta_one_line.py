...
##################################
def get_4clade_species(clade_f,ances):          #制作每个clade所含物种的字典
...
def process_og(fa):
    ...
    cladeDr = os.path.join(ogDr, "sp363")
    jsnFile = os.path.join(cladeDr, "{}_sp363.fasta-gb.fna.ABSREL.json".format(ogg))
...
if __name__ == "__main__":
    ...
    clade_f = "/home/c-dingpengjun/dingpengjun/ASR/000/GALGAL_R00001/clade1/subclades_sps.txt"
    clade_sps_dt =get_4clade_species(clade_f,anc_js)
    clade_in_sps_dt = clade_sps_dt
    clade_out_sps_dt={}
    clade_out_sps_dt[clade]=""

    clade_sps = sorted(clade_sps_dt[clade])
    hyphyOutDr = "/hwfssz5/ST_DIVERSITY/B10K/USER/chenwanjun/1.b10k/09.global_selection_analysis/run/run363/hyphy_363_global_out"
    # get the jsonFile
    faLst = []
